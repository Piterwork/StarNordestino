...
<head>
    ...
    <title>PAGINA INSTALACOES</title>
    ...
    <main>
        <div class="main-contenier">
            ...
            <div class="main-header">
                <h2 id="alvo">INSTALAÇÕES</h2>
            
                <p>Queremos que a sua estadia no nosso luxuoso hotel seja verdadeiramente  inesquecível. É por isso que damos atenções especial a todas as suas necessidades para que possamos garantir uma expereiência bastante  única. Hotéis de luxo oferecem o cenário perfeito com vistas deslumbrantes para lazer e nossas modernas instalações de resort de luxo irão ajudá-lo a aproveitar o melhor de tudo.</p>
            </div>

            <section class="section-fots">
                
                <div class="rows">
                    <div class="contenier-fotos ">
                        <img id="img-config" src="./assets/img/div1_academia.webp" alt="foto_academia">
                        <h3 class="main-label">ACADEMIA</h3>
                    </div>

                    <div class="contenier-fotos">
                        <img id="img-config" src="./assets/img/div2_bar.webp" alt="foto_barexterno">
                        <h3 class="main-label">BAR EXTERNO</h3>
                    </div>
                </div>

                <div class="rows">
                    <div class="contenier-fotos">
                        <img id="img-config" src="./assets/img/div3_spa.webp" alt="foto_spa">
                        <h3 class="main-label">SPA</h3>
                    </div>

                    <div class="contenier-fotos">
                        <img id="img-config" src="./assets/img/div4_piscina.webp" alt="foto_piscina">                    
                        <h3 class="main-label">PISCINA</h3>
                    </div>
                </div>

                <div class="rows">
                    <div class="contenier-fotos">
                        <img id="img-config" src="./assets/img/div5_lavanderia.webp" alt="foto_lavanderia">
                        <h3 class="main-label">LAVANDERIA</h3>            
                    </div>

                    <div class="contenier-fotos">
                        <img id="img-config" src="./assets/img/div6_restaurante.webp" alt="foto_restaurantes">
                        <h3 class="main-label">RESTAURANTES</h3>
                    </div> 
                </div>
